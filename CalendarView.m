...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [label setBackgroundColor:[UIColor colorWithRed:98.0/255.0 green:167.0/255.0 blue:209.0/255.0 alpha:1.0]];
...
//      NSLog(@"components%d %d %d",_selectedDate,_selectedMonth,_selectedYear);
    ...
    [titleText setTextColor:[UIColor colorWithRed:98.0/255.0 green:167.0/255.0 blue:209.0/255.0 alpha:1.0]];
    ...
    for (int i =0; i<_weekNames.count; i++) {
        ...
        [weekNameLabel setTitleColor:[UIColor colorWithRed:98.0/255.0 green:167.0/255.0 blue:209.0/255.0 alpha:1.0] forState:UIControlStateNormal];
    ...
    for (NSInteger i= 0; i<monthLength; i++)
    {
        ...
        [button setTitleColor:[UIColor colorWithRed:98.0/255.0 green:167.0/255.0 blue:209.0/255.0 alpha:1.0] forState:UIControlStateNormal];
        ...
        [button.layer setBorderColor:[[UIColor colorWithRed:98.0/255.0 green:167.0/255.0 blue:209.0/255.0 alpha:1.0] CGColor]];
        [button.layer setBorderWidth:2.0];
        UIView *lineView = [[UIView alloc] init];
        lineView.backgroundColor = [UIColor colorWithRed:98.0/255.0 green:167.0/255.0 blue:209.0/255.0 alpha:1.0];
        ...
        [columnView setBackgroundColor:[UIColor colorWithRed:98.0/255.0 green:167.0/255.0 blue:209.0/255.0 alpha:1.0]];
        if((i+weekday)%7==0)
        {
        ...
        {
            [button setBackgroundColor:[UIColor colorWithRed:98.0/255.0 green:167.0/255.0 blue:209.0/255.0 alpha:1.0]];
    ...
    for (int i=0; i<weekday; i++) {
        ...
        UIView *lineView = [[UIView alloc]init];
        [lineView setBackgroundColor:[UIColor colorWithRed:98.0/255.0 green:167.0/255.0 blue:209.0/255.0 alpha:1.0]];
        [lineView setFrame:CGRectMake(0, 0, button.frame.size.width, 4)];
        [button addSubview:lineView];
...
-(IBAction)tappedDate:(UIButton *)sender
{
    ...
    if(!(_selectedDate == sender.tag && _selectedMonth == [components month] && _selectedYear == [components year]))
    {
        if(_selectedDate != -1)
        {
            ...
            [previousSelected setTitleColor:[UIColor colorWithRed:98.0/255.0 green:167.0/255.0 blue:209.0/255.0 alpha:1.0] forState:UIControlStateNormal];
            
        }
        
        [sender setBackgroundColor:[UIColor colorWithRed:98.0/255.0 green:167.0/255.0 blue:209.0/255.0 alpha:1.0]];
